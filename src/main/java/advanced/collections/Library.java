...
public class Library {
    ...
    public Map<Genre, Integer> getAllGenderWithNoOfBooks() {
    ...
    public int getNumberOfAllBooks() {
        ...
        //return booksByGenre.values().stream().map(Set::size).reduce(0, Integer::sum);
...
//                .collect(Collectors.joining(","));
    ...
    public void printAllBooksTileWithYearBetween(int startYear, int endYear) {
        booksByGenre
                .values()
                .stream()
                .flatMap(b -> b.stream())
